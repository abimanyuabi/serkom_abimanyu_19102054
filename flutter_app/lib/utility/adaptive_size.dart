...
class AdaptSize {
  static size({
    ...
    pixel8 = _mediaQueryData.size.width / 51.375;
    pixel10 = _mediaQueryData.size.width / 36;
    pixel12 = _mediaQueryData.size.width / 34.25;
    pixel14 = _mediaQueryData.size.width / 25.7143;
    pixel15 = _mediaQueryData.size.width / 24;
    pixel16 = _mediaQueryData.size.width / 25.6875;
    ...
    pixel30 = _mediaQueryData.size.width / 13.7;
    pixel32 = _mediaQueryData.size.width / 11.25;
    pixel34 = _mediaQueryData.size.width / 10.6;
    pixel36 = _mediaQueryData.size.width / 10;
    pixel40 = _mediaQueryData.size.width / 10.275;
    pixel60 = _mediaQueryData.size.width / 6.85;
    pixel75 = _mediaQueryData.size.width / 4.8;
    pixel96 = _mediaQueryData.size.width / 4.28125;
    pixel160 = _mediaQueryData.size.width / 2.256;
  }
